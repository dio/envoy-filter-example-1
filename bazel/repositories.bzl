...
def ext_dependencies():
    print("Fetching additional external dependencies...")
    _com_github_dwd_rapidxml()

def _com_github_dwd_rapidxml():
    _repository_impl(
        name = "com_github_dwd_rapidxml",
        build_file = "//external:rapidxml.BUILD",
    )
    native.bind(
        name = "rapidxml",
        actual = "@com_github_dwd_rapidxml//:rapidxml",
    )